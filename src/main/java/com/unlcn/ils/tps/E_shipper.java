 ...
 * @generated 
 */
@Entity(id = "entity:com.unlcn.ils.tps.e_shipper", table = "td_shipper", ds = "ilsdb")
public class E_shipper implements Serializable {
	private static final long serialVersionUID = 1743364420861952L;
	/**
	 *
	 */
	 ...
	 *
	 */
	@Column(id = "code", datatype = "string32")
