 ...
 * @generated  
 */
@Entity(id = "entity:com.unlcn.ils.tps.e_contactInformation", table = "tps_contact_information", ds = "ilsdb")
public class E_contactInformation implements Serializable {
	private static final long serialVersionUID = 1762751207161856L;
	/**
	 *
	 */
