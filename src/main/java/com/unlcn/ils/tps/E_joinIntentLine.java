 ...
 * @generated  
 */
@Entity(id = "entity:com.unlcn.ils.tps.e_joinIntentLine", table = "tps_join_intentline", ds = "ilsdb")
public class E_joinIntentLine implements Serializable {
	private static final long serialVersionUID = 1690646361292800L;
	/**
	 *序号
	 */
