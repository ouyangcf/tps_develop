 ...
 * @generated
 */ 
@Entity(id = "entity:com.unlcn.ils.tps.e_attached", table = "tps_attached", ds = "ilsdb")
public class E_attached implements Serializable {
	private static final long serialVersionUID = 1706181822152704L;
	/**
	 *
	 */
