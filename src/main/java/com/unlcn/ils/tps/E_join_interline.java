 ...
 * @generated 
 */ 
@Entity(id = "entity:com.unlcn.ils.tps.e_join_interline", table = "tps_join_intentline", ds = "ilsdb")
public class E_join_interline implements Serializable {
	private static final long serialVersionUID = 1687410100174848L;
	/**
	 *序号
	 */
