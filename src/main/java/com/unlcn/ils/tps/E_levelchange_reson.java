 ...
 * @generated  
 */
@Entity(id = "entity:com.unlcn.ils.tps.E_levelchange_reson", table = "tps_levelchange_reson", ds = "ilsdb")
public class E_levelchange_reson implements Serializable {
	private static final long serialVersionUID = 1683262262886400L;
	/**
	 *序号
	 */
